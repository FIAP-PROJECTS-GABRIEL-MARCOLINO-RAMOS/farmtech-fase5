...
- [x] CSV incluído e hash registrado.
- [x] Notebook com EDA, cinco algoritmos diferentes, métricas e conclusões.
- [x] Partições por grupo, preprocessamento dentro dos folds, teste reservado.
...
- [x] Cotação feita na calculadora AWS, São Paulo × Norte da Virgínia.
- [x] Linux, t4g.micro, 2 vCPUs, 1 GiB, até 5 Gigabit, 50 GB magnético.
...
- [ ] Ler e conseguir explicar o notebook e a cotação com suas próprias palavras.
